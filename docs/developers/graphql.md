...
Set the Craft Link field's GraphQL mode to full data. In URL-only mode, Craft returns the rendered URL/string shape for backwards compatibility.
...

  {
    "data": {
        "smartlinkManagerResolveSmartLink": {
            "id": 9016,
            "resolvedDestinationUrl": "https://apps.apple.com/us/app/careem-rides-food-more/id592978487",
...
query {
    smartlinkManagerSmartLinks(site: "en", limit: 10) {
      id
      title
      slug
      url
...

{
    "data": {
        "smartlinkManagerSmartLinks": [
            {
                "id": 9017,
                "title": "A very long title test to check the widet 2",
                "slug": "a-very-long-title-test-to-check-the-widet",
                "url": "https://short.craftcms.ddev.site/a-very-long-title-test-to-check-the-widet",
                "redirectUrl": "https://short.craftcms.ddev.site/a-very-long-title-test-to-check-the-widet",
                "qrCodeUrl": "https://short.craftcms.ddev.site/go/qr/a-very-long-title-test-to-check-the-widet?size=300&color=E100FF&bg=2b00ff&format=png&margin=1&moduleStyle=rounded&eyeStyle=square&eyeColor=00FF04&logo=3851",
                "fallbackUrl": "https://google.com",
                "iosUrl": "https://test.com",
                "androidUrl": "https://test.com",
                "hits": 1
            },
            {
                "id": 9016,
                "title": "Careem Test",
                "slug": "careem-test2",
                "url": "https://short.craftcms.ddev.site/careem-test2",
                "redirectUrl": "https://short.craftcms.ddev.site/careem-test2",
                "qrCodeUrl": "https://short.craftcms.ddev.site/go/qr/careem-test2?size=300&color=fbff00&bg=2b00ff&format=png&margin=1&moduleStyle=rounded&eyeStyle=square&eyeColor=ff006f&logo=624",
                "fallbackUrl": "https://www.careem.com/",
                "iosUrl": "https://apps.apple.com/us/app/careem-rides-food-more/id592978487",
                "androidUrl": "https://play.google.com/store/apps/details?id=com.careem.acma&hl=en",
                "hits": 2
            }
        ]
    }
...
query {
    entries(section: "channel", site: "en", limit: 3) {
      __typename
      title
      ... on channel_Entry {
        smartTest {
        ...
        "entries": [
            ...
            },
            {
                ...
                "testSmartlink": {
                    "type": "smartLink",
                    "label": "Custom Label",
                    "url": "https://short.craftcms.ddev.site/a-very-long-title-test-to-check-the-widet?urlSuffix",
                    "target": null,
                    "class": "class_test",
                    "ariaLabel": "ariaTest",
                    "smartLink": {
