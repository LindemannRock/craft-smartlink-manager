...
return [
    ...
    'Smart link base URL must start with http:// or https://' => 'Die Smart Link Basis-URL muss mit http:// oder https:// beginnen',
    'Smart link base URL cannot contain spaces.' => 'Die Smart Link Basis-URL darf keine Leerzeichen enthalten.',
    'Unsupported token in smart link base URL. Supported tokens: {siteHandle}, {siteId}, {siteUid}.' => 'Nicht unterstütztes Token in der Smart Link Basis-URL. Unterstützte Token: {siteHandle}, {siteId}, {siteUid}.',
    ...
    'Download all your current smart links as a CSV file for backup or migration to another site.' => 'Laden Sie alle aktuellen Smart Links als CSV-Datei herunter, um sie zu sichern oder auf eine andere Website zu migrieren.',
    'Import smart links from CSV. You\'ll map columns and preview before importing.' => 'Importieren Sie Smart Links aus CSV. Sie ordnen Spalten zu und sehen eine Vorschau, bevor importiert wird.',
    'Select a CSV file to import smart links' => 'Wählen Sie eine CSV-Datei zum Importieren von Smart Links',
    'No smart links to export.' => 'Keine Smart Links zum Exportieren vorhanden.',
    'Map your CSV columns to smart link fields. Required fields must be mapped.' => 'Ordnen Sie Ihre CSV-Spalten den Smart-Link-Feldern zu. Pflichtfelder müssen zugeordnet werden.',
