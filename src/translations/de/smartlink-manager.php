...
return [
    ...
    'The text to display on the Add button.' => 'Der Text, der auf der Schaltfläche „Hinzufügen" angezeigt wird.',
    ...
    'QR code cache cleared successfully.' => 'QR Code Cache erfolgreich gelöscht.',
    'Cleared {count} QR code caches.' => '{count} QR Code Caches gelöscht.',
    'Device cache cleared successfully.' => 'Geräteerkennung-Cache erfolgreich gelöscht.',
    'Cleared {count} device detection caches.' => '{count} Geräteerkennung-Caches gelöscht.',
    'All caches cleared successfully.' => 'Alle Caches erfolgreich gelöscht.',
    'Cleared {count} cache entries.' => '{count} Cache-Einträge gelöscht.',
    ...
    'Clear cached data to force regeneration. Useful after changing QR code settings or when troubleshooting.' => 'Gecachte Daten löschen, um eine Neugenerierung zu erzwingen. Nützlich nach Änderung der QR Code Einstellungen oder bei der Fehlerbehebung.',
    'Clear QR Cache' => 'QR Cache löschen',
    'Clear Device Cache' => 'Geräte-Cache löschen',
    ...
    'Failed to clear QR cache' => 'QR Cache konnte nicht gelöscht werden',
    'Failed to clear device cache' => 'Geräte-Cache konnte nicht gelöscht werden',
    'Failed to clear caches' => 'Caches konnten nicht gelöscht werden',
