...
• Empfohlen, für Produktionsseiten aktiviert zu lassen',
    ...
    'Missing required field: {field}' => 'Pflichtfeld fehlt: {field}',
    'Invalid fallback URL' => 'Ungültige Fallback-URL',
    'Invalid URL in field: {field}' => 'Ungültige URL im Feld: {field}',
    'Disallowed markup in title or description' => 'Nicht erlaubtes Markup in Titel oder Beschreibung',
    'QR format must be png or svg' => 'QR-Format muss png oder svg sein',
    'Invalid site' => 'Ungültige Website',
    'Image asset not found for {field}' => 'Bild-Asset für {field} nicht gefunden',
    'Slug already exists' => 'Slug existiert bereits',
    'Duplicate row for the same {slugField} and {siteField}' => 'Doppelte Zeile für dieselbe {slugField} und dieselbe {siteField}',
