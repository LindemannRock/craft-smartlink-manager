...
return [
    ...
    'Deleting {count} old analytics records' => '{count} alte Analysedatensätze werden gelöscht',
    ...
    'Analytics cleanup job has been queued. It will run in the background.' => 'Analysedaten-Bereinigungsauftrag wurde in die Warteschlange gestellt. Er wird im Hintergrund ausgeführt.',
    ...
    'Track Analytics' => 'Analytics verfolgen',
    'Track clicks and visitor data for {pluginName}' => 'Klicks und Besucherdaten für {pluginName} verfolgen',
    'When enabled, {pluginName} will track visitor interactions, device types, geographic data, and other analytics information.' => 'Bei Aktivierung verfolgt {pluginName} Besucherinteraktionen, Gerätetypen, geografische Daten und weitere Analytics-Informationen.',
    'Are you sure you want to disable analytics tracking for this {singularName}? This {singularName} will no longer collect visitor data and interactions.' => 'Möchten Sie das Analytics-Tracking für diese {singularName} wirklich deaktivieren? Diese {singularName} erfasst dann keine Besucherdaten und Interaktionen mehr.',
    ...
    'Detect user location for analytics' => 'Nutzerstandort für Analytics ermitteln',
...
• Empfohlen, für Produktionsseiten aktiviert zu lassen',
    ...
    'Analytics Export Options' => 'Analysedaten-Exportoptionen',
    ...
    'When enabled, analytics exports will include data from disabled {pluginName}' => 'Bei Aktivierung enthalten Analysedaten-Exporte Daten von deaktivierten {pluginName}',
    ...
    'When enabled, analytics exports will include data from expired {pluginName}' => 'Bei Aktivierung enthalten Analysedaten-Exporte Daten von abgelaufenen {pluginName}',
    ...
    'Integrate {pluginName} with third-party analytics and tracking services to push click events to Google Tag Manager, Google Analytics, and other platforms.' => '{pluginName} mit Analytics- und Tracking-Diensten von Drittanbietern integrieren, um Klick-Events an Google Tag Manager, Google Analytics und andere Plattformen zu senden.',
    ...
    'Push {smartLinksName} click events to Google Tag Manager and analytics platforms for tracking redirects, button clicks, and QR code scans.' => '{smartLinksName} Klick-Events an Google Tag Manager und Analytics-Plattformen senden, um Weiterleitungen, Button-Klicks und QR Code Scans zu verfolgen.',
    ...
    'Events are only sent when analytics tracking is enabled both globally and per-link' => 'Events werden nur gesendet, wenn Analytics-Tracking sowohl global als auch pro Link aktiviert ist',
    ...
    'Create permanent redirect records when {pluginName} slugs change. Provides centralized redirect management and analytics tracking.' => 'Permanente Weiterleitungseinträge erstellen, wenn sich {pluginName} Slugs ändern. Ermöglicht zentrale Weiterleitungsverwaltung und Analytics-Tracking.',
    ...
    'Import {count} smart link(s)?' => '{count} Smart Links importieren?',
    ...
    'Required field not mapped: Slug' => 'Erforderliches Feld nicht zugeordnet: Slug',
    'Error: You cannot map multiple CSV columns to the same field' => 'Fehler: Sie können nicht mehrere CSV-Spalten demselben Feld zuordnen',
    ...
    'Track Analytics (1/0)' => 'Analytics verfolgen (1/0)',
    ...
    'Analytics will appear here once your {singularName} starts receiving clicks.' => 'Analytics wird hier angezeigt, sobald Ihre {singularName} Klicks erhält.',
    ...
    // Utilities
    'Monitor link performance, track analytics, and manage cache for your {singularName} redirects and QR codes.' => 'Link-Leistung überwachen, Analytics verfolgen und Cache für {singularName} Weiterleitungen und QR Codes verwalten.',
