...
return [
    ...
    'Changing will break existing URLs. To migrate, redirect the old smart link prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.' => 'Änderung macht bestehende URLs ungültig. Zur Migration leiten Sie das alte Smart Link Präfix in Ihrem Weiterleitungswerkzeug, CDN oder Ihrer Serverkonfiguration auf das neue um, zum Beispiel: Quelle \'/old-prefix/*\' → Ziel \'{destinationExample}\'.',
    ...
    'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public smart links or QR landing pages.' => 'Einige Frontend-Templates fehlen. Öffnen Sie die <a href="{url}">Einrichtung</a> für geführte Kopieranweisungen, bevor Sie öffentliche Smart Links oder QR-Landing-Pages erstellen.',
    ...
    'Track clicks and visitor data for {pluralLowerName}. When enabled, {pluginName} will track visitor interactions, device types, geographic data, and other analytics information.' => 'Klicks und Besucherdaten für {pluralLowerName} verfolgen. Bei Aktivierung verfolgt {pluginName} Besucherinteraktionen, Gerätetypen, geografische Daten und weitere Analytics-Informationen.',
...
• Empfohlen, für Produktionsseiten aktiviert zu lassen',
    ...
    // Setup
    'Set up SmartLink Manager' => 'SmartLink Manager einrichten',
    'Complete these steps before creating public smart links and QR landing pages.' => 'Schließen Sie diese Schritte ab, bevor Sie öffentliche Smart Links und QR-Landing-Pages erstellen.',
    'Ready' => 'Bereit',
    'v{version}' => 'v{version}',
    'IP salt' => 'IP-Salt',
    'Analytics needs a privacy salt before public smart link tracking is ready.' => 'Analytics benötigt einen Datenschutz-Salt, bevor öffentliches Smart-Link-Tracking bereit ist.',
    'Analytics privacy salt is ready for public smart link tracking.' => 'Der Analytics-Datenschutz-Salt ist für öffentliches Smart-Link-Tracking bereit.',
    ...
    'Copy the starter templates before public smart links can render their frontend pages.' => 'Kopieren Sie die Starter-Templates, bevor öffentliche Smart Links ihre Frontend-Seiten rendern können.',
    'Copy the missing starter template before public smart links can render this frontend page.' => 'Kopieren Sie das fehlende Starter-Template, bevor öffentliche Smart Links diese Frontend-Seite rendern können.',
    'Copy the missing starter templates before public smart links can render redirect or QR pages.' => 'Kopieren Sie die fehlenden Starter-Templates, bevor öffentliche Smart Links Weiterleitungs- oder QR-Seiten rendern können.',
    'Note:' => 'Hinweis:',
    'Review and customize the copied templates before going live.' => 'Prüfen und passen Sie die kopierten Templates an, bevor Sie live gehen.',
    ...
    'Finish setup before creating public smart links and QR landing pages.' => 'Schließen Sie die Einrichtung ab, bevor Sie öffentliche Smart Links und QR-Landing-Pages erstellen.',
    'Open setup' => 'Einrichtung öffnen',
    'Setup complete.' => 'Einrichtung abgeschlossen.',
    'SmartLink Manager is ready to create public smart links and QR landing pages.' => 'SmartLink Manager ist bereit, öffentliche Smart Links und QR-Landing-Pages zu erstellen.',
