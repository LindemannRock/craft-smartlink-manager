...
return [
    ...
    'The text to display on the Add button.' => 'The text to display on the Add button.',
    ...
    'Skipped {label}: template already resolves for every enabled site.' => 'Skipped {label}: template already resolves for every enabled site.',
    ...
    'Changing will break existing URLs. To migrate, redirect the old smart link prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.' => 'Changing will break existing URLs. To migrate, redirect the old smart link prefix to the new one in your redirect tool, CDN, or server config, for example: Source \'/old-prefix/*\' → Destination \'{destinationExample}\'.',
    ...
    'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public smart links or QR landing pages.' => 'Some frontend templates are missing. Open <a href="{url}">setup</a> for guided copy instructions before creating public smart links or QR landing pages.',
...
• Recommended to keep enabled for production sites',
    ...
    'Import {count} smart link(s)?' => 'Import {count} smart link(s)?',
    ...
    'Invalid fallback URL' => 'Invalid fallback URL',
    'Invalid URL in field: {field}' => 'Invalid URL in field: {field}',
    'Disallowed markup in title or description' => 'Disallowed markup in title or description',
    'QR format must be png or svg' => 'QR format must be png or svg',
    'Invalid site' => 'Invalid site',
    'Image asset not found for {field}' => 'Image asset not found for {field}',
    'Slug already exists' => 'Slug already exists',
    'Duplicate row for the same {slugField} and {siteField}' => 'Duplicate row for the same {slugField} and {siteField}',
    ...
    'v{version}' => 'v{version}',
    'IP salt' => 'IP salt',
    'Analytics needs a privacy salt before public smart link tracking is ready.' => 'Analytics needs a privacy salt before public smart link tracking is ready.',
    'Analytics privacy salt is ready for public smart link tracking.' => 'Analytics privacy salt is ready for public smart link tracking.',
    ...
    'Copy the starter templates before public smart links can render their frontend pages.' => 'Copy the starter templates before public smart links can render their frontend pages.',
    'Copy the missing starter template before public smart links can render this frontend page.' => 'Copy the missing starter template before public smart links can render this frontend page.',
    'Copy the missing starter templates before public smart links can render redirect or QR pages.' => 'Copy the missing starter templates before public smart links can render redirect or QR pages.',
    'Note:' => 'Note:',
    ...
    'Finish setup before creating public smart links and QR landing pages.' => 'Finish setup before creating public smart links and QR landing pages.',
    'Open setup' => 'Open setup',
    'Setup complete.' => 'Setup complete.',
    '{pluginName} is ready to create public smart links and QR landing pages.' => '{pluginName} is ready to create public smart links and QR landing pages.',
