...
return [
    ...
    'Export analytics' => 'Analyse exporteren',
    'Clear analytics' => 'Analyse wissen',
    ...
    'View full analytics' => 'Volledige analyse bekijken',
    'You don\'t have permission to view analytics.' => 'U heeft geen toestemming om de analyse te bekijken.',
    'Analytics are disabled in plugin settings.' => 'Analyse is uitgeschakeld in de plugin-instellingen.',
    ...
    'Cleared {count} QR code caches.' => '{count} QR Code cache(s) gewist.',
    'Device cache cleared successfully.' => 'Apparaatdetectie-cache succesvol gewist.',
    'Cleared {count} device detection caches.' => '{count} apparaatdetectie-cache(s) gewist.',
    'All caches cleared successfully.' => 'Alle caches succesvol gewist.',
    'Cleared {count} cache entries.' => '{count} cache-items gewist.',
    ...
    'Choose what types of messages to log. Debug level requires devMode to be enabled.' => 'Kies welke typen berichten worden geregistreerd. Debug-niveau vereist dat devMode is ingeschakeld.',
    ...
    'Changing the URL prefix will break all existing {pluginName}. Only change this before creating your first {singularName}.' => 'Het wijzigen van het URL-prefix maakt alle bestaande {pluginName} ongeldig. Wijzig dit alleen vóór het aanmaken van uw eerste {singularName}.',
    ...
    'Changing will break existing URLs. To migrate, create wildcard redirect in {redirectPluginName}: Source \'/old/*\' → Destination \'/new/$1\' (Match Type: Wildcard)' => 'Wijziging maakt bestaande URL\'s ongeldig. Maak een wildcard-doorverwijzing in {redirectPluginName}: Bron "/old/*" → Bestemming "/new/$1" (Overeenkomsttype: Wildcard)',
    'Changing will break existing QR URLs. To migrate, create wildcard redirect in {redirectPluginName}: Source \'/old/*\' → Destination \'/new/$1\' (Match Type: Wildcard). Supports standalone (e.g., \'qr\') or nested (e.g., \'go/qr\') patterns.' => 'Wijziging maakt bestaande QR-URL\'s ongeldig. Maak een wildcard-doorverwijzing in {redirectPluginName}: Bron "/old/*" → Bestemming "/new/$1" (Wildcard). Ondersteunt zelfstandige (bijv. "qr") of geneste (bijv. "go/qr") patronen.',
    ...
    'Enable automatic language detection to redirect users based on their browser or location' => 'Automatische taaldetectie inschakelen om gebruikers om te leiden op basis van hun browser of locatie',
    ...
    'Device detection caching is only available when Analytics is enabled. Go to' => 'Apparaatdetectie-caching is alleen beschikbaar wanneer Analyse is ingeschakeld. Ga naar',
    'to enable analytics.' => 'om analyse in te schakelen.',
    ...
    'Results are cached to avoid re-parsing the same user-agent repeatedly' => 'Resultaten worden gecached om dezelfde user-agent niet herhaaldelijk te hoeven analyseren',
    'Recommended to keep enabled for production sites' => 'Aanbevolen om ingeschakeld te houden voor productiesites',
    ...
    'Number of {pluginName} to show per page' => 'Aantal {pluginName} per pagina',
    ...
    'Total cached entries' => 'Totaal gecachede items',
    ...
    'Failed to clear analytics' => 'Analyses konden niet worden gewist',
    ...
    'Select the geo IP lookup provider. HTTPS providers recommended for privacy.' => 'Selecteer de geo-IP-lookupprovider. HTTPS-providers worden aanbevolen voor privacy.',
    ...
    'ip-api.com free tier uses HTTP. IP addresses will be transmitted unencrypted. Add an API key for HTTPS (Pro tier) or switch to ipapi.co/ipinfo.io.' => 'Gratis niveau van ip-api.com gebruikt HTTP. IP-adressen worden onversleuteld verzonden. Voeg een API-sleutel toe voor HTTPS (Pro-niveau) of schakel over naar ipapi.co/ipinfo.io.',
    'ip-api.com: HTTP free tier (45 requests/min). Add API key for HTTPS (Pro tier, $13/month). IP addresses transmitted unencrypted without API key.' => 'ip-api.com: gratis HTTP-niveau (45 verzoeken/min). Voeg API-sleutel toe voor HTTPS (Pro-niveau, $13/maand). Zonder API-sleutel worden IP-adressen onversleuteld verzonden.',
